...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="message" id="disclaimer">
      <p><strong>Disclaimer:</strong> I want to apologize for my grammar and mistakes in this post. I am not a native speaker and try to become better. But hey, please help me: <a href="<?php bloginfo('url'); ?>/contact/">send me a mail</a> or <a href="http://twitter.com/drublic">tweet me</a>. Thank you, you're awesome!</p>
    </div>
