...
?> <!doctype html> <!--[if lt IE 7]><html class="no-js ie6 oldie" <?php language_attributes(); ?>><![endif]--> <!--[if IE 7]><html class="no-js ie7 oldie" <?php language_attributes(); ?>><![endif]--> <!--[if IE 8]><html class="no-js ie8 oldie" <?php language_attributes(); ?>><![endif]--> <!--[if gt IE 8]><!--> <html class=no-js <?php language_attributes(); ?>> <!--<![endif]--> <head> <meta charset="<?php bloginfo( 'charset' ); ?>"> <meta http-equiv=X-UA-Compatible content="IE=edge,chrome=1"> <title><?php
	 ...
	 */
	wp_head();
?> </head> <body <?php body_class(); ?>> <div id=container> <header id=header> <div id=inner-header class=clearfix> <div id=logo> <a href="http://drublic.de">@drublic</a> / <a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel=home>blog</a> <div class=visuallyhidden><?php bloginfo( 'name' ); ?> - <?php bloginfo( 'description' ); ?></div> </div> <ul id=misc> <li class=search-icon><a href="#/search" title="Try searching&hellip;">Search</a></li> </ul> <div id=search class=content-widget> <a href="#/close/search" title="Close the search" class=close>&times;</a> <div class=inner> <form action="<?php bloginfo( 'home' ); ?>/" method=post> <fieldset> <label for=s>Search the articles</label> <input type=search id=s name=s> </fieldset> <fieldset> <input type=submit id=submit-search name=submit-search value=Search> </fieldset> </form> </div> </div> </div> </header> <div id=main role=main>